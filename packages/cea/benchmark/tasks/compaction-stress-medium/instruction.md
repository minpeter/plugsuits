...
STEP 1: Create a simple Node.js calculator module at work/calc.js:
```
...
STEP 2: Create work/calc.test.js:
```
...
STEP 3: Run the test: use shell_execute to run `node work/calc.test.js`

STEP 4: Create work/index.js:
```
const calc = require('./calc');
...
STEP 5: Run work/index.js with shell_execute: `node work/index.js`

STEP 6: Create work/summary.txt with EXACTLY this content (recall from memory what you built):
